...
public class ConferenceProjetApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Role role2 = accountMetier.saveRole(new Role(null, "REVIWER"));
		Role role3 = accountMetier.saveRole(new Role(null, "REVIWER"));
		Role role4 = accountMetier.saveRole(new Role(null, "CHAIR"));
//		Role role5 = accountMetier.saveRole(new Role(null, ""));
